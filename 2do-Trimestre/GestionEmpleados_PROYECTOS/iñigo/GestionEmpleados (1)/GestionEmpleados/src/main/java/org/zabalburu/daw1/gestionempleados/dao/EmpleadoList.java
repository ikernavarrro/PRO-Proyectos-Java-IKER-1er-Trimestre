...
public class EmpleadoList implements EmpleadoDAO {
    ...
    public EmpleadoList() {
        ...
        empleados.add(new Empleado(1, "Juan", "Pérez López",
                ...
                "juan.perez@example.com", "1.jpg", 25000.0,0));
        ...
        empleados.add(new Empleado(2, "María", "García Gómez",
                ...
                "maria.garcia@example.com", "2.jpg", 27000.0,2));
        ...
        empleados.add(new Empleado(3, "Luis", "Martín Santos",
                ...
                "luis.martin@example.com", "3.jpg", 30000.0,1));
        ...
        empleados.add(new Empleado(4, "Ana", "Ruiz Fernández",
                ...
                "ana.ruiz@example.com", "4.jpg", 22000.0,2));
        ...
        empleados.add(new Empleado(5, "Carlos", "Sánchez Mora",
                ...
                "carlos.sanchez@example.com", "5.jpg", 28000.0,3));
        ...
        empleados.add(new Empleado(6, "Laura", "Díaz Torres",
                ...
                "laura.diaz@example.com", "6.jpg", 26000.0,0));
        ...
        empleados.add(new Empleado(7, "Javier", "Romero García",
                ...
                "javier.romero@example.com", "7.jpg", 32000.0,2));
        ...
        empleados.add(new Empleado(8, "Sara", "Hernández Pardo",
                ...
                "sara.hernandez@example.com", "8.jpg", 24000.0,1));
        ...
        empleados.add(new Empleado(9, "Miguel", "Navarro Ruiz",
                ...
                "miguel.navarro@example.com", "9.jpg", 29000.0,0));
        ...
        empleados.add(new Empleado(10, "Elena", "Serrano López",
                ...
                "elena.serrano@example.com", "10.jpg", 25000.0,4));
        ...
        empleados.add(new Empleado(11, "Pedro", "López García",
                ...
                "pedro.lopez@example.com", "11.jpg", 31000.0,2));
        ...
        empleados.add(new Empleado(12, "Lucía", "Ortega Ramos",
                ...
                "lucia.ortega@example.com", "12.jpg", 23000.0,1));
        ...
        empleados.add(new Empleado(13, "Diego", "Vega Martín",
                ...
                "diego.vega@example.com", "13.jpg", 27000.0,0));
        ...
        empleados.add(new Empleado(14, "Isabel", "Campos Pérez",
                ...
                "isabel.campos@example.com", "14.jpg", 26000.0,1));
        ...
        empleados.add(new Empleado(15, "Hugo", "Santos Molina",
                ...
                "hugo.santos@example.com", "15.jpg", 33000.0,2));
        ...
        empleados.add(new Empleado(16, "Paula", "Rey Castro",
                ...
                "paula.rey@example.com", "16.jpg", 21000.0,3));
        ...
        empleados.add(new Empleado(17, "Alberto", "Soto Gil",
                ...
                "alberto.soto@example.com", "17.jpg", 30000.0,1));
        ...
        empleados.add(new Empleado(18, "Natalia", "Iglesias Robles",
                ...
                "natalia.iglesias@example.com", "18.jpg", 25000.0,2));
        ...
        empleados.add(new Empleado(19, "Sergio", "Cano Blanco",
                ...
                "sergio.cano@example.com", "19.jpg", 34000.0,1));
        ...
        empleados.add(new Empleado(20, "Eva", "Mendoza Sáez",
                ...
                "eva.mendoza@example.com", "20.jpg", 22000.0,2));
    ...
    public void modificarEmpleado(Empleado modificar) {
        // El id de modificar es el del empleado que quiero cambiar
        // Buscar la posición del empleado con ese id,
        /*int i; 
        for(i=0; i<empleados.size() && 
            !modificar.equals(empleados.get(i));
            i++);
        if (i < empleados.size()){
            // Está en la posición i
            // Cambiamos el que está en esa posición por el modificado
            empleados.set(i, modificar);
        }*/
        int pos = empleados.indexOf(modificar); // EQUALS en base al ID
        if (pos != -1) {
